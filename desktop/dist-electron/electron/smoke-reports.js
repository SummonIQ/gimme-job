...
export async function readSmokeReport(input) {
    ...
    const report = normalizeSmokeReport(input.filePath, await readJsonFile(input.filePath));
    if (!report) {
...
export function isPathInsideDirectory(baseDir, filePath) {
...
function normalizeSmokeReport(filePath, value) {
...
function normalizeRuntimeProvider(value) {
    ...
    if (!id || !label || !isRuntimeReadiness(readiness))
        return null;
    return {
        id,
        label,
...
function normalizeRequest(value) {
    ...
    if (!runtimeProviderId || count === null)
        return null;
    return {
        count,
...
function toSmokeReportSummary(report) {
    return {
