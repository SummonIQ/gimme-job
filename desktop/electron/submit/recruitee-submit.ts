...
const RECRUITEE_OVERRIDES: GenericSubmitProviderOverrides = {
...
export async function runRecruiteeSubmitLead(
...
export function isRecruiteeApplicationUrl(url: string): boolean {
